...
public class TaskSender {
	...
	public void cancelRide(String rideId) {
		...
		template.convertAndSend(directExchange.getName(), RabbitMQConstant.SEATS_CANCEL_KEY, new UpdateSeats(rideId, Operation.CANCEL));
	}
	...
	public void closeRide(String rideId) {
		...
		template.convertAndSend(directExchange.getName(), RabbitMQConstant.SEATS_CLOSE_KEY, new UpdateSeats(rideId, Operation.CLOSE));
	}
}
