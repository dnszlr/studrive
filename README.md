...
The scripts that are used to measure the non-functional requirements availability and performance efficiency can be found [here](https://github.com/dnszlr/studrive/tree/master/clientside-shellscript).
